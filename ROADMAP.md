# 🗺️ DSA-Mastery: 6-Month Complete Roadmap
...
- [ ] Linear Search
- **Problems**: 10 sorting + 10 searching
...
- [ ] Counting bits, power of 2
- **Problems**: 20 bit manipulation problems
...
- [ ] Fenwick tree (BIT)
- [ ] Range queries
- **Problems**: 15 segment tree problems
...
- [ ] Behavioral interview prep (STAR)
...
```
Morning (1.5 hrs):  Learn new concept + implement
Afternoon (1 hr):   Solve 3-5 problems
Evening (30 min):   Review, revise, note patterns
Weekend (3 hrs):    Mock interview or contest
```
